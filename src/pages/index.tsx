...
export default function Home() {
    ...
    return (
        <>
            ...
            <main className="md:px-20 px-5 py-10 flex h-screen min-w-screen flex-col items-center justify-items-start bg-slate-50 gap-10">
                <div>
                    <span className="font-mono font-bold text-7xl text-amber-400 font-outline-4">Pokédex</span>
                </div>
                <Tabs variant="scrollable" className="rounded-md" component={Paper} value={selectedTab} onChange={(event, value: number) => {
                    setSelectedTab(value)
                }}>
                    <Tab label="Search one"/>
